          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
              ...
              <li className="nav-item _header_nav_item" ref={notifyRef}>
                ...
                >
                  ...
                  {isNotifyOpen && (
                    <div
                      id="_notify_drop"
                      className="_notification_dropdown _mar_t18"
                      style={{
                        display: "block",
                        opacity: 1,
                        visibility: "visible",
            ...
            <div className="_header_nav_profile" ref={profileRef}>
              ...
              {isProfileOpen && (
                <div
                  id="_prfoile_drop"
                  className="_nav_profile_dropdown _profile_dropdown _mar_t18"
                  style={{
                    display: "block",
                    opacity: 1,
                    visibility: "visible",
                  ...
                  <ul className="_nav_dropdown_list">
                    ...
                    <li className="_nav_dropdown_list_item">
                      <a href="#0" className="_nav_dropdown_link">
                        <div className="_nav_drop_info">
                          <span>
                            <Icon name={"help-and-support"}></Icon>
                          </span>
                          Help & Support
                        </div>
                        <button type="submit" className="_nav_drop_btn_link">
